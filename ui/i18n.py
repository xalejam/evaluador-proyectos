"""Módulo de internacionalización. Fuente única de TRANSLATIONS y función t()."""
...
TRANSLATIONS: dict[str, dict] = {
    "es": {
        ...
        "ops_capture_help_info": "Guía rápida:\n- General: contexto y decisión.\n- Próximo paso: acción + responsable + fecha.\n- Bloqueador: qué detiene y quién destraba.\n- Riesgo: posible problema y mitigación.",
        ...
        "dashboard_avg_reported_time_saved": "Tiempo Ahorrado Reportado",
        "dashboard_feedback_metrics": "📣 Métricas de Feedback",
        "dashboard_avg_nps": "NPS Promedio",
        "dashboard_nps_net": "NPS Neto",
        "dashboard_nps_segments": "% Promotores / Pasivos / Detractores",
        "dashboard_usage_frequency_distribution": "Distribución de Frecuencia de Uso",
        "dashboard_nps_vs_satisfaction": "NPS vs Satisfacción",
        "dashboard_no_feedback_data": "Aún no hay datos de frecuencia/NPS para mostrar en dashboard.",
        ...
        "feedback_frequency_metric": "Frecuencia",
        "feedback_nps_metric": "NPS",
        ...
        "feedback_expected_excel_structure_markdown": "**Estructura esperada del Excel:**\n\n| Columna | Descripción | Formato |\n|---------|-------------|---------|\n| ID DEL PROYECTO a evaluar | Identificador del proyecto | Texto (ej: MX-XIO-0001) |\n| ¿Qué tan satisfecho/a estás con la nueva herramienta? | Satisfacción del usuario | Número 1-10 |\n| ¿Con qué frecuencia utilizas esta herramienta? | Frecuencia de uso | Diario / Semanal / Mensual / Ocasional |\n| ¿Qué porcentaje de tiempo te ahorra comparado con el proceso anterior? | Tiempo ahorrado reportado | Número 0-100 (acepta 12.5 o 12,5) |\n| ¿Qué beneficios adicionales has notado? | Beneficios inesperados | Texto libre (opcional) |\n| ¿Qué problemas o dificultades has enfrentado? | Desafíos enfrentados | Texto libre (opcional) |\n| ¿Qué tan probable es que recomiendes esta herramienta a un compañero? | NPS | Número 0-10 |\n| Procesado | Marca de procesamiento | Vacío / Sí / No |",
        ...
        "feedback_time_saved_conversion_markdown": "**Tiempo Ahorrado:** Directo 0-100% (acepta coma o punto decimal)",
        ...
        "new_scoring_explanation": "🎯 **Nuevo Sistema de Scoring (100 puntos):**\n- ⚡ **Factor de Impacto (35 puntos)**\n- ⚠️ **Factor de Riesgo (30 puntos)**\n- 🔧 **Factor de Complejidad (35 puntos)**",
    },
    "pt": {
        ...
        "ops_capture_help_info": "Guia rápido:\n- Geral: contexto e decisão.\n- Próximo passo: ação + responsável + data.\n- Bloqueador: o que impede e quem destrava.\n- Risco: possível problema e mitigação.",
        ...
        "dashboard_avg_reported_time_saved": "Tempo Economizado Reportado",
        "dashboard_feedback_metrics": "📣 Métricas de Feedback",
        "dashboard_avg_nps": "NPS Médio",
        "dashboard_nps_net": "NPS Líquido",
        "dashboard_nps_segments": "% Promotores / Passivos / Detratores",
        "dashboard_usage_frequency_distribution": "Distribuição de Frequência de Uso",
        "dashboard_nps_vs_satisfaction": "NPS vs Satisfação",
        "dashboard_no_feedback_data": "Ainda não há dados de frequência/NPS para exibir no dashboard.",
        "dashboard_initial_vs_real_performance": "Score Inicial vs Performance Real",
        ...
        "feedback_frequency_metric": "Frequência",
        "feedback_nps_metric": "NPS",
        ...
        "feedback_expected_excel_structure_markdown": "**Estrutura esperada do Excel:**\n\n| Coluna | Descrição | Formato |\n|---------|-------------|---------|\n| ID DEL PROYECTO a evaluar | Identificador do projeto | Texto (ex: MX-XIO-0001) |\n| ¿Qué tan satisfecho/a estás con la nueva herramienta? | Satisfação do usuário | Número 1-10 |\n| ¿Con qué frecuencia utilizas esta herramienta? | Frequência de uso | Diario / Semanal / Mensual / Ocasional |\n| ¿Qué porcentaje de tiempo te ahorra comparado con el proceso anterior? | Tempo economizado reportado | Número 0-100 (aceita 12.5 ou 12,5) |\n| ¿Qué beneficios adicionales has notado? | Benefícios inesperados | Texto livre (opcional) |\n| ¿Qué problemas o dificultades has enfrentado? | Desafios enfrentados | Texto livre (opcional) |\n| ¿Qué tan probable es que recomiendes esta herramienta a un compañero? | NPS | Número 0-10 |\n| Procesado | Marca de processamento | Vazio / Sim / Não |",
        ...
        "feedback_time_saved_conversion_markdown": "**Tempo Economizado:** Direto 0-100% (aceita vírgula ou ponto decimal)",
        ...
        "new_scoring_explanation": "🎯 **Novo Sistema de Scoring (100 pontos):**\n- ⚡ **Fator de Impacto (35 pontos)**\n- ⚠️ **Fator de Risco (30 pontos)**\n- 🔧 **Fator de Complexidade (35 pontos)**",
    },
}
