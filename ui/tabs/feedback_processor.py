...
def render_feedback_processor():
    ...
    with tab1:
        ...
        uploaded_file = st.file_uploader(
            t("feedback_select_excel_label"),
            type=['xlsx', 'xls'],
            help=t("feedback_select_excel_help")
        )
    ...
    with tab2:
        ...
        with col_conv1:
            ...
            satisfaction_example = pd.DataFrame({
                'Cuestionario': [1, 5, 8, 10],
                'Tracking': [1, 5, 8, 10]
            })
        ...
        with col_conv2:
            ...
            time_example = pd.DataFrame({
                'Cuestionario (1-10)': [1, 3, 7, 10],
                'Tracking (%)': [0, 22.2, 66.7, 100]
            })
